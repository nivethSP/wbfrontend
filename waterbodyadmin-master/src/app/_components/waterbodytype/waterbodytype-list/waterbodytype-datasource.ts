...
export class WaterBodyTypeDataSource implements DataSource<Resource>
{
    ...
    constructor(private waterbodyTypeService: WaterbodytypeService) {}
    ...
    fetchWaterBodyTypes(sortField: string, sortOrder: string,filterValue: string, pageIndex = 0, pageSize = 10) {
        this.loadingSubject.next(true);
        this.waterbodyTypeService.getList(
            sortField,sortOrder,filterValue, pageIndex, pageSize).pipe(
            catchError(handleError<any>('fetchWaterBodyTypes', null)),
