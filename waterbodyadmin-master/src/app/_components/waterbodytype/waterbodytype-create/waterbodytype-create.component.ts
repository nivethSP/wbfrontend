...
@Component({
  selector: 'app-waterbodytype-create',
  templateUrl: './waterbodytype-create.component.html',
  styleUrls: ['./waterbodytype-create.component.css']
})
export class WaterbodytypeCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyTypeService: WaterbodytypeService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyTypeService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyTypeService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyTypeService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
