...
@Component({
  selector: 'app-waterbodyshutter-create',
  templateUrl: './waterbodyshutter-create.component.html',
  styleUrls: ['./waterbodyshutter-create.component.css']
})
export class WaterbodyshutterCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyshutterService: WaterbodyshutterService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyshutterService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyshutterService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyshutterService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
