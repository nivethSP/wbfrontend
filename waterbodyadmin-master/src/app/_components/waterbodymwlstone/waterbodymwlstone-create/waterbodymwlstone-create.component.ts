...
@Component({
  selector: 'app-waterbodymwlstone-create',
  templateUrl: './waterbodymwlstone-create.component.html',
  styleUrls: ['./waterbodymwlstone-create.component.css']
})
export class WaterbodymwlstoneCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodymwlstoneService: WaterbodymwlstoneService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodymwlstoneService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodymwlstoneService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodymwlstoneService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
