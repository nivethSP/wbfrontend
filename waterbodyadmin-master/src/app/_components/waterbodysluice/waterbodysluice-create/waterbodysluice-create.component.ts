...
@Component({
  selector: 'app-waterbodysluice-create',
  templateUrl: './waterbodysluice-create.component.html',
  styleUrls: ['./waterbodysluice-create.component.css']
})
export class WaterbodysluiceCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodysluiceService: WaterbodysluiceService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodysluiceService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodysluiceService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodysluiceService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
