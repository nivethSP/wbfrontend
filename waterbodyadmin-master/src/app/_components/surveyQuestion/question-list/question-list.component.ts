...
export class QuestionListComponent implements OnInit {
  ...
  displayedColumns = ["question", "statusText", "details", "update", "delete"];
  dataLength: number
  ...
  constructor(private questionService: QuestionService, private router: Router, private dialog: MatDialog,
    private errorService: ErrorHandlerService) { }

    ngOnInit(): void {
      this.dataSource = new QuestionDataSource(this.questionService);
      this.dataSource.fetchQuestions('question', 'asc', '');
    ...
    BindQuestions() {
      ...
      this.dataSource.fetchQuestions(
        this.sort.active,
        this.sort.direction,
        this.filterValue,
    ...
    public redirectToUpdate = (id: string) => {
      let url: string = `/question/edit/${id}`;
      this.router.navigate([url]);
    }
