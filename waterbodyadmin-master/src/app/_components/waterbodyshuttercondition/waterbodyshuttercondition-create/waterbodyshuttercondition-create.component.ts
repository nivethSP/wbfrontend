...
@Component({
  selector: 'app-waterbodyshuttercondition-create',
  templateUrl: './waterbodyshuttercondition-create.component.html',
  styleUrls: ['./waterbodyshuttercondition-create.component.css']
})
export class WaterbodyshutterconditionCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyshutterconditionService: WaterbodyshutterconditionService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyshutterconditionService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyshutterconditionService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyshutterconditionService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
