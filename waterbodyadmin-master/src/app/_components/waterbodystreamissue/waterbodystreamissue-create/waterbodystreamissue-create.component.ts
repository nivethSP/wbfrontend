...
@Component({
  selector: 'app-waterbodystreamissue-create',
  templateUrl: './waterbodystreamissue-create.component.html',
  styleUrls: ['./waterbodystreamissue-create.component.css']
})
export class WaterbodystreamissueCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodystreamissueService: WaterbodystreamissueService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodystreamissueService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodystreamissueService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodystreamissueService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
