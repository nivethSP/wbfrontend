...
@Component({
  selector: 'app-waterbodysurplusweir-create',
  templateUrl: './waterbodysurplusweir-create.component.html',
  styleUrls: ['./waterbodysurplusweir-create.component.css']
})
export class WaterbodysurplusweirCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodysurplusweirService: WaterbodysurplusweirService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodysurplusweirService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodysurplusweirService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodysurplusweirService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
