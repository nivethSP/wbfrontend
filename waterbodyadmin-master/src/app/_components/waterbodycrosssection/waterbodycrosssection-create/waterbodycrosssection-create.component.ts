...
@Component({
  selector: 'app-waterbodycrosssection-create',
  templateUrl: './waterbodycrosssection-create.component.html',
  styleUrls: ['./waterbodycrosssection-create.component.css']
})
export class WaterbodycrosssectionCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodycrosssectionService: WaterbodycrosssectionService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodycrosssectionService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodycrosssectionService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodycrosssectionService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
