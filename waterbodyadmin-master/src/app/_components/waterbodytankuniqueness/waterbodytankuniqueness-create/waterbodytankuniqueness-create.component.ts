...
@Component({
  selector: 'app-waterbodytankuniqueness-create',
  templateUrl: './waterbodytankuniqueness-create.component.html',
  styleUrls: ['./waterbodytankuniqueness-create.component.css']
})
export class WaterbodytankuniquenessCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodytankuniquenessService: WaterbodytankuniquenessService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodytankuniquenessService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodytankuniquenessService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodytankuniquenessService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
