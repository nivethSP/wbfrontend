...
@Component({
  selector: 'app-waterbodyfamilydistributionland-create',
  templateUrl: './waterbodyfamilydistributionland-create.component.html',
  styleUrls: ['./waterbodyfamilydistributionland-create.component.css']
})
export class WaterbodyfamilydistributionlandCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyfamilydistributionlandService: WaterbodyfamilydistributionlandService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyfamilydistributionlandService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyfamilydistributionlandService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyfamilydistributionlandService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
