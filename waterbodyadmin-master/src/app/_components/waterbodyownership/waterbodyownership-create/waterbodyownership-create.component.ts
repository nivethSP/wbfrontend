...
@Component({
  selector: 'app-waterbodyownership-create',
  templateUrl: './waterbodyownership-create.component.html',
  styleUrls: ['./waterbodyownership-create.component.css']
})
export class WaterbodyownershipCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodytypeownershipService: WaterbodytypeownershipService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodytypeownershipService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodytypeownershipService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodytypeownershipService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
