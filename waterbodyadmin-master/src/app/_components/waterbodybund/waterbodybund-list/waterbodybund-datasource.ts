...
export class WaterBodyBundDataSource implements DataSource<Resource>
{
    ...
    constructor(private waterbodybundService: WaterbodybundService) {}
    ...
    fetchWaterBodyBunds(sortField: string, sortOrder: string,filterValue: string, pageIndex = 0, pageSize = 10) {
        this.loadingSubject.next(true);
        this.waterbodybundService.getList(
            sortField,sortOrder,filterValue, pageIndex, pageSize).pipe(
            catchError(handleError<any>('fetchWaterBodyBunds', null)),
