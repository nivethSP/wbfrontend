...
@Component({
  selector: 'app-waterbodybund-create',
  templateUrl: './waterbodybund-create.component.html',
  styleUrls: ['./waterbodybund-create.component.css']
})
export class WaterbodybundCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodybundService: WaterbodybundService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodybundService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodybundService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodybundService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
