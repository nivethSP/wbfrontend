...
@Component({
  selector: 'app-waterbodyavailability-create',
  templateUrl: './waterbodyavailability-create.component.html',
  styleUrls: ['./waterbodyavailability-create.component.css']
})
export class WaterbodyavailabilityCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyavailabilityService: WaterbodyavailabilityService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyavailabilityService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyavailabilityService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyavailabilityService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
