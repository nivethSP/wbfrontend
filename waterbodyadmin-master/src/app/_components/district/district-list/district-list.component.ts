...
import { District } from 'src/app/_model/District';
...
export class DistrictListComponent implements OnInit {
  ...
  dataSource: ResourceDataSource<District>;
  ...
  constructor(private districtService: DistrictService, private router: Router, private dialog: MatDialog,
    private errorService: ErrorHandlerService) { }

    ngOnInit(): void {
      this.dataSource = new ResourceDataSource(this.districtService);
    ...
    public redirectToDetails = (id: string) => {
      let url: string = `/district/details/${id}`;
      this.router.navigate([url]);
    }
    public redirectToUpdate = (id: string) => {
      let url: string = `/district/edit/${id}`;
      this.router.navigate([url]);
    }
