...
@Component({
  selector: 'app-waterbodyexoticspecies-create',
  templateUrl: './waterbodyexoticspecies-create.component.html',
  styleUrls: ['./waterbodyexoticspecies-create.component.css']
})
export class WaterbodyexoticspeciesCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyexoticspeciesService: WaterbodyexoticspeciesService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyexoticspeciesService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyexoticspeciesService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyexoticspeciesService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
