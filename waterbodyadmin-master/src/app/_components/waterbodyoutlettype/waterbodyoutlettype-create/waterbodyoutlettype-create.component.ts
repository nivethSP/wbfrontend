...
@Component({
  selector: 'app-waterbodyoutlettype-create',
  templateUrl: './waterbodyoutlettype-create.component.html',
  styleUrls: ['./waterbodyoutlettype-create.component.css']
})
export class WaterbodyoutlettypeCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyoutlettypeService: WaterbodyoutlettypeService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyoutlettypeService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyoutlettypeService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyoutlettypeService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
