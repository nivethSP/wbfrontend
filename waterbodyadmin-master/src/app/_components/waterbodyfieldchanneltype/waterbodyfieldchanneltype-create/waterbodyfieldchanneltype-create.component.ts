...
@Component({
  selector: 'app-waterbodyfieldchanneltype-create',
  templateUrl: './waterbodyfieldchanneltype-create.component.html',
  styleUrls: ['./waterbodyfieldchanneltype-create.component.css']
})
export class WaterbodyfieldchanneltypeCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterBodyfieldchanneltypeService: WaterBodyfieldchanneltypeService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterBodyfieldchanneltypeService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterBodyfieldchanneltypeService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterBodyfieldchanneltypeService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
