...
@Component({
  selector: 'app-waterbodytankissue-create',
  templateUrl: './waterbodytankissue-create.component.html',
  styleUrls: ['./waterbodytankissue-create.component.css']
})
export class WaterbodytankissueCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodytankissueService: WaterbodytankissueService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodytankissueService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodytankissueService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodytankissueService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
