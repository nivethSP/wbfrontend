...
export class WaterBodyTankIssueDataSource implements DataSource<Resource>
{
    ...
    constructor(private waterbodytankissueService: WaterbodytankissueService) {}
    ...
    fetchWaterBodyTankIssues(sortField: string, sortOrder: string,filterValue: string, pageIndex = 0, pageSize = 10) {
        this.loadingSubject.next(true);
        this.waterbodytankissueService.getList(
            sortField,sortOrder,filterValue, pageIndex, pageSize).pipe(
            catchError(handleError<any>('fetchWaterBodyTankIssues', null)),
