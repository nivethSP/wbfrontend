...
@Component({
  selector: 'app-waterbodyspreadissue-create',
  templateUrl: './waterbodyspreadissue-create.component.html',
  styleUrls: ['./waterbodyspreadissue-create.component.css']
})
export class WaterbodyspreadissueCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterBodySpreadIssuesService: WaterBodySpreadIssuesService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterBodySpreadIssuesService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterBodySpreadIssuesService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterBodySpreadIssuesService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
