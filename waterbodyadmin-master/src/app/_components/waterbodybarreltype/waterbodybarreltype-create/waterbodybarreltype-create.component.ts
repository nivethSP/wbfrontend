...
@Component({
  selector: 'app-waterbodybarreltype-create',
  templateUrl: './waterbodybarreltype-create.component.html',
  styleUrls: ['./waterbodybarreltype-create.component.css']
})
export class WaterbodybarreltypeCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodybarrelTypeService: WaterbodybarrelTypeService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodybarrelTypeService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodybarrelTypeService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodybarrelTypeService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
