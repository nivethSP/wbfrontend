...
@Component({
  selector: 'app-waterbodystonepitchingcondition-create',
  templateUrl: './waterbodystonepitchingcondition-create.component.html',
  styleUrls: ['./waterbodystonepitchingcondition-create.component.css']
})
export class WaterbodystonepitchingconditionCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodystonepitchingconditionService: WaterbodystonepitchingconditionService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodystonepitchingconditionService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodystonepitchingconditionService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodystonepitchingconditionService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
