...
@Component({
  selector: 'app-waterbodyslittrap-create',
  templateUrl: './waterbodyslittrap-create.component.html',
  styleUrls: ['./waterbodyslittrap-create.component.css']
})
export class WaterbodyslittrapCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyslittrapService: WaterbodyslittrapService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyslittrapService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyslittrapService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyslittrapService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
