...
@Component({
  selector: 'app-waterbodycondition-create',
  templateUrl: './waterbodycondition-create.component.html',
  styleUrls: ['./waterbodycondition-create.component.css']
})
export class WaterbodyconditionCreateComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private waterbodyconditionService: WaterbodyconditionService,
  ...
  ngOnInit(): void {
    ...
    if (!this.isAddMode) {
      this.waterbodyconditionService.get(this.id)
        .pipe(first())
  ...
  private createResource() {
    ...
    this.waterbodyconditionService.create(newresource)
      .pipe(first())
      .subscribe({
        next: () => {
  ...
  private updateResource() {
    ...
    this.waterbodyconditionService.update(this.id, updatedresource)
      .pipe(first())
      .subscribe({
        next: () => {
          let dialogRef = this.dialog.open(SuccessDialogComponent, this.dialogConfig);
